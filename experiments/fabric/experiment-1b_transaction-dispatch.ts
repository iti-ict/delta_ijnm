 ...
 * Experimento Hyperledger Fabric 1.2: Recepción de transacciones en el cliente
 */
...
class ExperimentFabric1_2 extends FabricMongoApplication {
...
async function main() {
    const deltaApp = new ExperimentFabric1_2(netConnProf, confOpts, wallet, dbConnOpts, smartContract);
    await deltaApp.run();
}
